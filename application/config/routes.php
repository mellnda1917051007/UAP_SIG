...
$route['RS'] = 'administrator/RS';
$route['tampilRS'] = 'administrator/tampilRS';
$route['savedataRS'] = 'administrator/saveDataRS';
$route['editdataRS'] = 'administrator/editDataRS';
$route['hapusRS'] = 'administrator/hapusRS';
